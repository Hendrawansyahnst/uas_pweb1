   ...
   export default {
     ...
     methods: {
       getPeminjamanDetail(id) {
         axios
             .get('https://nstbooknii.000webhostapp.com/bookstore/select_peminjaman_detail.php?id='+id)
             .then(response => {
       ...
       getPeminjaman(id) {
         axios
             .get('https://nstbooknii.000webhostapp.com/bookstore/select_peminjaman_master_id.php?id='+id)
             .then(response => {
