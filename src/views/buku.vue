...
export default {
  ...
  methods: {
    cariBuku(){
      axios
          .get('https://nstbooknii.000webhostapp.com/bookstore/selectBuku.php?q='+this.q)
          .then(response => {
    ...
    getBukuList() {
      axios
          .get('https://nstbooknii.000webhostapp.com/bookstore/selectBuku.php')
          .then(response => {
            this.buku = response.data;
          })
          .catch(error => {
    ...
    hapusBuku(id) {
      axios
          .delete(`https://nstbooknii.000webhostapp.com/bookstore/deleteBukubyKode.php?id=${id}`)
          .then(response => {
...
.button-edit {
  ...
  border-radius: 12px;
  box-shadow: transparent 0 0 0 3px, rgba(102, 255, 0, 0.514) 0 6px 20px;
...
.button-edit:hover {
  box-shadow: #af0202 0 0 0 3px, transparent 0 0 0 0;
}
...
.button-delete {
  ...
  background-color: #fff;
  border-radius: 12px;
  box-shadow: transparent 0 0 0 3px, rgba(7, 3, 207, 0.411) 0 6px 20px;
  box-sizing: border-box;
  color: #0044ff;
  cursor: pointer;
  display: inline-flex;
...
.button-delete:hover {
  box-shadow: #0400ff 0 0 0 3px, transparent 0 0 0 0;
}
...
.button-add {
  ...
  background-color: #fff;
  border-radius: 12px;
  box-shadow: transparent 0 0 0 3px, rgba(0, 128, 187, 0.466) 0 6px 20px;
  box-sizing: border-box;
  color: #0099ff;
  cursor: pointer;
  display: inline-flex;
...
.button-add:hover {
  box-shadow: #00ffdd 0 0 0 3px, transparent 0 0 0 0;
}
