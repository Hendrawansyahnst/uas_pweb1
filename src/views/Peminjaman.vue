<template>
  ...
  export default {
    ...
    methods: {
      getPeminjamanList() {
        axios
            .get('https://nstbooknii.000webhostapp.com/bookstore/daftar_peminjaman_buku.php?status='+this.status)
            .then(response => {
  ...
  .button-add {
    ...
    border-radius: 12px;
    box-shadow: transparent 0 0 0 3px, rgba(28, 30, 85, 0.1) 0 6px 20px;
  ...
  .button-add:hover {
    box-shadow: #1e5552 0 0 0 3px, transparent 0 0 0 0;
  }
  </style>