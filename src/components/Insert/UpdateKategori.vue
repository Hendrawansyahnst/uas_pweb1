<template>
  ...
  export default {
    ...
    methods: {
      getKategori(id) {
        axios
            .get('https://nstbooknii.000webhostapp.com/bookstore/selectKategoribyKode.php?id='+id)
            .then(response => {
      ...
      editAnggota(){
        axios
            .post('https://nstbooknii.000webhostapp.com/bookstore/updateKategoribyKode.php',
                this.category, {
                  headers: {
